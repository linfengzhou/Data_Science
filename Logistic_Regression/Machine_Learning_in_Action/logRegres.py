#import os
#os.chdir('E:\Code\machinelearninginaction code\ch05')
import numpy as np
import random
...
### Plotting the logistics regression best-fit line and dataset
def plotBestFit(wei):
...
def stocGradAscent0(dataMatrix, classLabels):
    ...
    return np.matrix(weights).transpose()
...
## classify with logstics regression
